...
public class MCreatorCcccccccOre extends Elementstestremoteworkspack.ModElement {
	@ObjectHolder("testremoteworkspack:ccccccccore")
	public static final Block block = null;

	public MCreatorCcccccccOre(Elementstestremoteworkspack instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorCcccccccGem.block, (int) (1)));
		}
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("ccccccccore", "ccccccccore", blockAt -> {
